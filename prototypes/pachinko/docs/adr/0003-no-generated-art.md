...
# The presentation uses no generated art

This repo ships `asset-gen`, and a real pachinko machine's presentation is licensed anime IP — so the obvious move is to generate a cast of characters and build reach sequences around them. We are not doing that. The entire presentation is built from Godot shaders, particles and tweens: orbiting bodies, alignment, a black hole. Nothing is drawn or generated.
